...
def server_loop(local_host, local_port, remote_host, remote_port, receive_first):
    ...
    while True:
        ...
        # print out the tlocal connection information
...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
    ...
    # Receive data from the remote and send if necessary
    if receive_first:
    ...
    while True:
        ...
        if len(local_buffer):
            ...
            # sednt off the data to the remote host
...
def receive_from(connection):
    buffer = ''
    # We set a 2 second timeout: depending on you target, this may need to be adjusted
...
def main():
    # no fancy command-line arguments here
    if len(sys.argv[1:]) != 5:
