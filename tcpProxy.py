...
def server_loop(local_host, local_port, remote_host, remote_port, receive_first):
    ...
    try:
        ...
        print '[!!] Failed to listen on %s:%d::%s' % (local_host, local_port, e)
        sys.exit(0)
...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
    ...
    while True:
        ...
        # if no more data on either side, close the connedtion
...
def main():
    ...
    # setup remote host target
    remote_host = sys.argv[3]
    remote_port = int(sys.argv[4])
    # this tells our proxy to connect and receive data before sendinf to remote host
